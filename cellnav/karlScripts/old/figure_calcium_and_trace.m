...
fileNames={'Ai148_129SVG3_Translation_122618_1005.mat', ...
    ...
    meanImgs=cell(12,1);
    meanMat=double(zeros(size(avg,1),size(avg,2),12));
for m=1:12
        ...
        meanImgs{m}=meanImg;
        meanMat(:,:,m)=meanImg;
        scaleFactor=prctile(meanImg(:),90);
        meanImgScaled=meanImg./scaleFactor;
        %figure(); imshow(meanImgScaled);
