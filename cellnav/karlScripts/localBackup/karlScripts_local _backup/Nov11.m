...
for i=1:length(regionNames)
    ...
    imwrite(curPhysMeanImg,['Y:\MATLAB\cellNav\cellNav_0.70\karl\images\emPhys\' curPhysImFilename]);
...
for i=1:length(planeFits)
    ...
    for q=1:fitIterations
        tf3d=estimateGeometricTransform(physPts(:,[1 2]),vastCoordsDS(:,[1 2]),'similarity');
        tftr(:,:,q)=tf3d.T;
    end
    ...
    emCorners=transformPointsForward(tf3d,corners);
    emCorners2=transformPointsForward(tf3d,corners2);
