...
postT=1;
postS=tis.cells.type.subTypeNames{1} ; %{1};
preT=8;
preS={1};

bpcSyns={};
for i=1:59
    bpcSyns{i}=getClassConn(postT,postS(i),preT,preS);
...
if makefig==1
    ...
    xticks(1:60);
    xlabel('bpc subtype');
    xticklabels(tis.cells.type.subTypeNames{1});
end
