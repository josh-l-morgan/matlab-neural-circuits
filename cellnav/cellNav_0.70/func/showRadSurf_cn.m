function[fv p] = showRadSurf_cnv(posR,edgeR,radR,nodeColR,alph,tempFig)
...
hold on
% daspect(tempAx,[1,1,1]);
% view(tempAx,3); axis tight;
% set(tempAx,'color',[0 0 0]);
% set(tempFig,'color',[0 0 0]);
% set(tempAx,'visible','off','clipping','off')
% 
% l = findobj(gcf,'Type','Light');
% if isempty(l)
%     l = lightangle(tempAx,145,45) ;
% end
