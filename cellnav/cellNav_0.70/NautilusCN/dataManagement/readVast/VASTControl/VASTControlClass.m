classdef VASTControlClass < handle
  ...
  %%%% VERSION: 5.5, March 20, 2020 - for VAST Lite 1.2.1.24x
  ...
  properties
    ...
    parseheaderlen=0;
    lasterror=0;
    thisversionnr=5; %Version 5 is for VAST Lite 1.3
    thissubversionnr=4;
...
%     29 Higher 32 bits of user ID
    ...
    function res=splitselectedskeleton(obj, newrootdfsnr, newname)
    ...
    function [id, res] = setannoobject(obj, id, aodata)
      ...
      obj.sendmessage(obj.SETANNOOBJECT,[obj.bytesfromuint32(id) obj.bytesfromdata(encodefromstruct(aodata))]);
      obj.readdatablock();
      parse(obj,obj.indata);
      res=processerror(obj);
      if (res==1)
    ...
    function [state, res] = getcurrentuistate(obj)
      ...
      res=processerror(obj);
      if (res==1)
        if ((obj.nrinuints==5)&&(obj.nrindoubles==0)&&(obj.nrinints==7)&&(obj.nrintext==0))
      ...
      while (ptr<length(indata))
        ...
        switch type
          ...
          case 3
            ...
            ptr=ptr+8;
            eval(['out.' variablename ' = ' sprintf('%lf',value) ';']);
          case 4
            %character string
            ptr2=ptr;
            while (indata(ptr2)~=0) ptr2=ptr2+1; end;
