        ...
        for y = 1:ceil(rangeN(2,1)/boxSize)
            ...
            for x = 1:ceil(rangeN(2,2)/boxSize)
                ...
                for z = 1:ceil(rangeN(2,3)/boxSize)
                     ...
                     hasN =  ((fullPosNds(:,1)+rangeBuf)>((y-1)*boxSize)) & ((fullPosNds(:,1)-rangeBuf)<(y*boxSize)) & ...
                        ((fullPosNds(:,2)+rangeBuf)>((x-1)*boxSize)) & ((fullPosNds(:,2)-rangeBuf)<(x*boxSize)) & ...
                        ((fullPosNds(:,3)+rangeBuf)>((z-1)*boxSize)) & ((fullPosNds(:,3)-rangeBuf)<(z*boxSize));
