function[pathLengths] = drawPathTip2Seed(pred,dists,increment,tips)


%%Draws path distance and owner based on seed paths. second input is value of tips used to sort priority.
...
%% Sort tips
[sortDists distIDX] = sort( dists,'descend');
