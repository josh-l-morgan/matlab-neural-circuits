function varargout = cellNavGuide_26(varargin)
% CELLNAVGUIDE_26 MATLAB code for cellNavGuide_26.fig
%      CELLNAVGUIDE_26, by itself, creates a new CELLNAVGUIDE_26 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_26 returns the handle to a new CELLNAVGUIDE_26 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_26('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_26.M with the given input arguments.
%
%      CELLNAVGUIDE_26('Property','Value',...) creates a new CELLNAVGUIDE_26 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_26_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_26_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_26

% Last Modified by GUIDE v2.5 14-Jun-2020 22:42:38
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_26_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_26_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_26 is made visible.
function cellNavGuide_26_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_26 (see VARARGIN)

% Choose default command line output for cellNavGuide_26
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_26 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_26_OutputFcn(hObject, eventdata, handles)
