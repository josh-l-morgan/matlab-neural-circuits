function varargout = cellNavGuide_15(varargin)
% CELLNAVGUIDE_15 MATLAB code for cellNavGuide_15.fig
%      CELLNAVGUIDE_15, by itself, creates a new CELLNAVGUIDE_15 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_15 returns the handle to a new CELLNAVGUIDE_15 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_15('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_15.M with the given input arguments.
%
%      CELLNAVGUIDE_15('Property','Value',...) creates a new CELLNAVGUIDE_15 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_15_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_15_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_15

% Last Modified by GUIDE v2.5 06-Jun-2020 11:13:24
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_15_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_15_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_15 is made visible.
function cellNavGuide_15_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_15 (see VARARGIN)

% Choose default command line output for cellNavGuide_15
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_15 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_15_OutputFcn(hObject, eventdata, handles)
