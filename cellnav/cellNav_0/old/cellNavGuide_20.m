function varargout = cellNavGuide_20(varargin)
% CELLNAVGUIDE_20 MATLAB code for cellNavGuide_20.fig
%      CELLNAVGUIDE_20, by itself, creates a new CELLNAVGUIDE_20 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_20 returns the handle to a new CELLNAVGUIDE_20 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_20('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_20.M with the given input arguments.
%
%      CELLNAVGUIDE_20('Property','Value',...) creates a new CELLNAVGUIDE_20 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_20_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_20_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_20

% Last Modified by GUIDE v2.5 12-Jun-2020 16:29:36
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_20_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_20_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_20 is made visible.
function cellNavGuide_20_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_20 (see VARARGIN)

% Choose default command line output for cellNavGuide_20
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_20 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_20_OutputFcn(hObject, eventdata, handles)
