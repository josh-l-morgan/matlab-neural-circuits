function varargout = cellNavGuide_24(varargin)
% CELLNAVGUIDE_24 MATLAB code for cellNavGuide_24.fig
%      CELLNAVGUIDE_24, by itself, creates a new CELLNAVGUIDE_24 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_24 returns the handle to a new CELLNAVGUIDE_24 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_24('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_24.M with the given input arguments.
%
%      CELLNAVGUIDE_24('Property','Value',...) creates a new CELLNAVGUIDE_24 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_24_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_24_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_24

% Last Modified by GUIDE v2.5 14-Jun-2020 21:08:23
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_24_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_24_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_24 is made visible.
function cellNavGuide_24_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_24 (see VARARGIN)

% Choose default command line output for cellNavGuide_24
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_24 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_24_OutputFcn(hObject, eventdata, handles)
