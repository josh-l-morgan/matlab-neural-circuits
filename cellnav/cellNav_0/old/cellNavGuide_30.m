function varargout = cellNavGuide_30(varargin)
% CELLNAVGUIDE_30 MATLAB code for cellNavGuide_30.fig
%      CELLNAVGUIDE_30, by itself, creates a new CELLNAVGUIDE_30 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_30 returns the handle to a new CELLNAVGUIDE_30 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_30('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_30.M with the given input arguments.
%
%      CELLNAVGUIDE_30('Property','Value',...) creates a new CELLNAVGUIDE_30 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_30_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_30_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_30

% Last Modified by GUIDE v2.5 15-Jun-2020 17:35:23
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_30_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_30_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_30 is made visible.
function cellNavGuide_30_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_30 (see VARARGIN)

% Choose default command line output for cellNavGuide_30
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_30 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_30_OutputFcn(hObject, eventdata, handles)
