function varargout = cellNavGuide_22t(varargin)
% CELLNAVGUIDE_22T MATLAB code for cellNavGuide_22t.fig
%      CELLNAVGUIDE_22T, by itself, creates a new CELLNAVGUIDE_22T or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_22T returns the handle to a new CELLNAVGUIDE_22T or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_22T('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_22T.M with the given input arguments.
%
%      CELLNAVGUIDE_22T('Property','Value',...) creates a new CELLNAVGUIDE_22T or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_22t_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_22t_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_22t

% Last Modified by GUIDE v2.5 13-Jun-2020 18:29:18
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_22t_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_22t_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_22t is made visible.
function cellNavGuide_22t_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_22t (see VARARGIN)

% Choose default command line output for cellNavGuide_22t
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_22t wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_22t_OutputFcn(hObject, eventdata, handles)
