function varargout = cellNavGuide_33(varargin)
% CELLNAVGUIDE_33 MATLAB code for cellNavGuide_33.fig
%      CELLNAVGUIDE_33, by itself, creates a new CELLNAVGUIDE_33 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_33 returns the handle to a new CELLNAVGUIDE_33 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_33('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_33.M with the given input arguments.
%
%      CELLNAVGUIDE_33('Property','Value',...) creates a new CELLNAVGUIDE_33 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_33_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_33_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_33

% Last Modified by GUIDE v2.5 17-Jun-2020 09:34:17
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_33_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_33_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_33 is made visible.
function cellNavGuide_33_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_33 (see VARARGIN)

% Choose default command line output for cellNavGuide_33
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_33 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_33_OutputFcn(hObject, eventdata, handles)
