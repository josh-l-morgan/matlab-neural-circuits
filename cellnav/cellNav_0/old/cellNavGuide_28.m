function varargout = cellNavGuide_28(varargin)
% CELLNAVGUIDE_28 MATLAB code for cellNavGuide_28.fig
%      CELLNAVGUIDE_28, by itself, creates a new CELLNAVGUIDE_28 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_28 returns the handle to a new CELLNAVGUIDE_28 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_28('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_28.M with the given input arguments.
%
%      CELLNAVGUIDE_28('Property','Value',...) creates a new CELLNAVGUIDE_28 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_28_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_28_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_28

% Last Modified by GUIDE v2.5 15-Jun-2020 15:38:14
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_28_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_28_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_28 is made visible.
function cellNavGuide_28_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_28 (see VARARGIN)

% Choose default command line output for cellNavGuide_28
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_28 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_28_OutputFcn(hObject, eventdata, handles)
