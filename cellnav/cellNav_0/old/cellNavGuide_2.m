function varargout = cellNavGuide_2(varargin)
% CELLNAVGUIDE_2 MATLAB code for cellNavGuide_2.fig
%      CELLNAVGUIDE_2, by itself, creates a new CELLNAVGUIDE_2 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_2 returns the handle to a new CELLNAVGUIDE_2 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_2.M with the given input arguments.
%
%      CELLNAVGUIDE_2('Property','Value',...) creates a new CELLNAVGUIDE_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_2

% Last Modified by GUIDE v2.5 07-May-2020 20:24:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cellNavGuide_2_OpeningFcn, ...
                   'gui_OutputFcn',  @cellNavGuide_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_2 is made visible.
function cellNavGuide_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_2 (see VARARGIN)

% Choose default command line output for cellNavGuide_2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_2 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_2_OutputFcn(hObject, eventdata, handles) 
...
val = str2num(str{1});
fileName = sprintf('%s%d.mat',glob.fvDir,val);
load(fileName);
%     set(handles.mainAx)
...
set(handles.edit1,'String',num2str(glob.pickCID))
