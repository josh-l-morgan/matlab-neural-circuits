function varargout = cellNavGuide_37(varargin)
% CELLNAVGUIDE_37 MATLAB code for cellNavGuide_37.fig
%      CELLNAVGUIDE_37, by itself, creates a new CELLNAVGUIDE_37 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_37 returns the handle to a new CELLNAVGUIDE_37 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_37('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_37.M with the given input arguments.
%
%      CELLNAVGUIDE_37('Property','Value',...) creates a new CELLNAVGUIDE_37 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_37_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_37_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_37

% Last Modified by GUIDE v2.5 23-Jun-2020 15:37:45
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_37_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_37_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_37 is made visible.
function cellNavGuide_37_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_37 (see VARARGIN)

% Choose default command line output for cellNavGuide_37
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_37 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_37_OutputFcn(hObject, eventdata, handles)
...
str = {'Import Data','Create Custom Object', 'Create Custom Group',...
    'Model Transmission','Copy cellNav'};
set(hObject,'String',str);
