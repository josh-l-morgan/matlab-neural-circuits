function varargout = cellNavGuide_36(varargin)
% CELLNAVGUIDE_36 MATLAB code for cellNavGuide_36.fig
%      CELLNAVGUIDE_36, by itself, creates a new CELLNAVGUIDE_36 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_36 returns the handle to a new CELLNAVGUIDE_36 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_36('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_36.M with the given input arguments.
%
%      CELLNAVGUIDE_36('Property','Value',...) creates a new CELLNAVGUIDE_36 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_36_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_36_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_36

% Last Modified by GUIDE v2.5 19-Jun-2020 07:24:01
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_36_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_36_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_36 is made visible.
function cellNavGuide_36_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_36 (see VARARGIN)

% Choose default command line output for cellNavGuide_36
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_36 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_36_OutputFcn(hObject, eventdata, handles)
...
str = {'Import Data','Create Custom Object', 'Create Custom Group','Model Transmission'};
set(hObject,'String',str);
