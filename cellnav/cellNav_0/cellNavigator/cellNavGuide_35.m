function varargout = cellNavGuide_35(varargin)
% CELLNAVGUIDE_35 MATLAB code for cellNavGuide_35.fig
%      CELLNAVGUIDE_35, by itself, creates a new CELLNAVGUIDE_35 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_35 returns the handle to a new CELLNAVGUIDE_35 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_35('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_35.M with the given input arguments.
%
%      CELLNAVGUIDE_35('Property','Value',...) creates a new CELLNAVGUIDE_35 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_35_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_35_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_35

% Last Modified by GUIDE v2.5 17-Jun-2020 12:49:33
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_35_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_35_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_35 is made visible.
function cellNavGuide_35_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_35 (see VARARGIN)

% Choose default command line output for cellNavGuide_35
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_35 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_35_OutputFcn(hObject, eventdata, handles)
