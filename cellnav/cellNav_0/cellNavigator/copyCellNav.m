...
% Last Modified by GUIDE v2.5 24-Jun-2020 21:59:10
...
if get(handles.checkbox_fvLibraries,'Value')
...
% --- Executes on button press in checkbox_fvLibraries.
function checkbox_fvLibraries_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_fvLibraries (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_fvLibraries
