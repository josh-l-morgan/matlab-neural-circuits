...
for i = 1:length(hRange)
    ...
    if isempty(reSameVals)
        placeHolder = 0;
        reSame(i) = placeHolder;
        reSameInt(i,:) = placeHolder;
        rlSameVals = placeHolder;
        rlSame(i) =placeHolder;
        rlSameInt(i,:) = placeHolder;
        reDif(i) = placeHolder;
        reDifInt(i,:) = placeHolder;
...
%% compare influence of disance vs cell on roi similarity
