function[cellSubs] = obj2conBranch(obI,dsObj,cid,separateBranches)

if ~exist('separateBranches','var')
    separateBranches = 0;
end
...
%%Skeletonize each branch separately and then merge if separateBranches or
%%merge all voxels before skeletonizing. 
if ~separateBranches
    isIndi = isIndi * 0;
    indis = [];
end
