...
if 1 % all
    ...
    testConductances = [ 10^-7  10^-6 10^-5 10^-4 10^-3 10^-2 10^-1 10^-3.5 10^-2.5 10^-2.75 10^-1.5];
    runConThisTime = [length(testConductances)-1 : length(testConductances)];
else %test
    runCids = 20;
    testConductances = [10^-7  10^-2];
    runConThisTime = [1 2];
end
