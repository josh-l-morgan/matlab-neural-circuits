...
if testType == 1
    ...
    % eachCond = 10.^[-6 -5 -4];
    % eachExcite = [10^-3 10^-4];
    % eachInhib =  [10^-3 10^-4 10^-5];;
    % eachOffScale = [1 0.5 0.1];  
    % expName = 'exp_01_c';

    %% Ref2
    % runCids = [ 2 3 4 5 13 14 20]    
    % eachCond = 10.^[-6.5 -6 -5.5 ];
    % eachExcite = [10^-2.5 10^-3 10^-3.5];
    % eachInhib =  [10^-3.5 10^-4 10^-4.5];;
    % eachOffScale = [1.25 1 .75];  
    % expName = 'exp_01_d';
...
elseif testType ==2; %list each
    ...
    testInhibWeight = [10.^-4 / 6];
    testOffScales = [0.5];
    testExciteWeight = [10.^-4];
...
jmFindLengthConstant_vs_NEURON_05
