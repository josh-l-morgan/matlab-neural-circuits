...
TPN = 'E:\Pratyush\Optical\confocal\th_tdt_121019_right_trap\20X_slow\03_oifStack_tweak7\'
mkdir(TPN) 
...
secs = [1:p]';
mean1 = squeeze(mean(mean(I1,1),2));
mean2 = squeeze(mean(mean(I2,1),2));

plot(mean1)
pol1 = polyfit(secs,mean1,3);
pred1 = polyval(pol1,secs);
