...
prompt = {'Volume in voxels','Maximum number of threshold passes',...
    'Volume integrated threshold passes', 'Delta F/F (top half)'};
title = 'First Pass Thresholds: enter minimum values';
nLines = 1;

FirstThresholds= inputdlg(prompt,title,nLines,{'3','3','300','.3'});
...
fullID=zeros(Dots.ImSize);


for i = 1: size(P,2)
%    fullID(Dots.Vox(P(i)).Ind)=1000;
