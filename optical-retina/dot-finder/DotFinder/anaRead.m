...
prompt = {'dendrite channel: ', 'post synaptic channel', 'colocalizing channel:  ',...
    'xy resolution : ', 'z resolution :','median filter post? (1=yes, 0=no)'};
title = 'Define image channels. (0 if not applicable)';
nLines = 1;

ImageInfo= inputdlg(prompt,title,nLines,{'3','1','2',num2str(xyum),num2str(zum),'1'});
