...
if exist([TPN 'FirstThresholds.mat'])
    load([TPN 'FirstThresholds.mat'])
else
    FirstThresholds={'3', '3', '100', '0.3', '0'}
end

'First Pass Thresholds: enter minimum values', pause(.1)
...
FirstThresholds= inputdlg(prompt,title,nLines,FirstThresholds);

pause(.1)

if FirstThresholds{5}=='1'
   FirstThresholds={'3', '3', '100', '0.3', '0'};
end


save([TPN 'FirstThresholds.mat'],'FirstThresholds');


for i = 1: length(FirstThresholds)
    ftNum(i)=str2num(FirstThresholds{i});
end
...
save([TPN 'data\FirstThresholds.mat'],'FirstThresholds')
...
pass=pVol & pCut & pItSum & pITMax & pContrast & pContrastV & pDFOf & pDofTop & pDF & pD2M ;
...
pass2=pSGflatDelta & pSGdcon & pSGdeltaScale & pSGcontrast & pVol & pCut & pItSum & pITMax & pContrast & pContrastV & pDFOf & pDofTop & pDF & pD2M;
