...
for k = 65:65%size(Kdir,1)
    ...
    if ~isfield(SKStatus,'FM'),SKStatus.FM=0,end
 
    
    
  %  SKStatus.FM=0;   save([TPN 'SKStatus.mat'],'SKStatus'); end
    if 1%~SKStatus.FM  %run fast mask if not run before
