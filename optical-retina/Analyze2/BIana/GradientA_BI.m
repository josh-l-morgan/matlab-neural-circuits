...
for k = 1:NumCells
    ...
    clear Area Dots Dend
        Area(:,:,1)=CA.Arbor(1).Territory *xyum^2/0.103^2;
        Area(:,:,2)=CA.Arbor(2).Territory * xyum^2/0.103^2;
        Dots(:,:,1)=CA.Arbor(1).DotMap;
        Dots(:,:,2)=CA.Arbor(2).DotMap;
        Dend(:,:,1)=CA.Arbor(1).DendMap * xyum/0.103;
        Dend(:,:,2)=CA.Arbor(2).DendMap * xyum/0.103;
