...
for k = 1: NumCells
   ...
   for i = 1:size(Mids,1)
      ...
      DtoMidsMed(i)=abs(medianDepth-Mids(i,3));
   end
   ...
   DepthDev.AllDotsMean=DtoDots;
   DepthDev.AllMidsMean=DtoMids;
   DepthDev.AllDotsMed=DtoDotsMed;
   DepthDev.AllMidsMed=DtoMidsMed;
   DepthDev.NumDots=NumDots;
   DepthDev.NumMids=NumMids;
