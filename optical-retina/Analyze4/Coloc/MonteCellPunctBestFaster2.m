...
TPN=GetMyDir
Reps=5;
DilateDistance=2; %max distance dilated
...
for i = 1: length(VoxPs)
    ...
    DiSpaceV(DiVoxInd)=1;
    DiSpace=DiSpaceV;
    DiSpace=imdilate(DiSpace,Cube); %!!!!!!!!! NO MORE Dilation
...
for i =1: length(VoxPs)
    ...
    ShowSurround(CheckI)=ShowSurround(CheckI)+fix(rand*200)+50;
...
mcTop=mcSum; mcTop5=mcSum; mcPeak=mcSum; mcMean=mcSum; mcIT=mcSum; mcpThresh=mcSum;
