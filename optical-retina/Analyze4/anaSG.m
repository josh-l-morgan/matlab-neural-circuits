...
%% Draw image
'Drawing images'
maxID=zeros(Dots.ImSize(1),Dots.ImSize(2),'double');
AllmaxID=zeros(Dots.ImSize(1),Dots.ImSize(2),'double');
...
for i = 1: size(P,2)
   maxID(mod(Dots.Vox(P(i)).Ind-1,YXsize)+1)=P(i);  % i think unnecessary
