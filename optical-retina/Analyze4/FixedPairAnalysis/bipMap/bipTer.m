...
%%Find territory
    ...
    TerFilt=imfilter(uint8(sum(I,3)*1000),Disk2,'same');
    TerFilt=TerFilt>0;
    %{
    ...
    numTer = length(find(Territory));
    
    celldat(allI,:) = {ImageFolders{allI},numArea, polyArea, numTer};
    allI
      ImageFolders{allI}
