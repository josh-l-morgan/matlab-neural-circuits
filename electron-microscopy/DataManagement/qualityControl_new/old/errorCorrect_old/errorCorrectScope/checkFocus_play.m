...
%         image(I)
        ...
        %% 4 comp
        sur = {[2 4 6 8], [1 2 3 6], [2 3 6 9],[1 3 7 9]};     
        cent = {[1 3 7 9], [9 8 7 4], [8 7 4 1],[1 2 4 5]};
 
        %%Other useful patterns
        sur =[sur {[1 2 3 4 6 7 8 9],[1 4 7  3 6 9],[1 2 3 7 8 9],...
            [1 2 4 6 8 9], [2 3 6 4 7 8],[1 3 8]}];
        cent = [cent {[5], [2 5 8],  [4 5 6],[3 5 7],[1 5 9],[7 2 9]}];
...
%% Make contrast image
        dome = fspecial('gaussian',size(difMap,1),size(difMap,1)/3);
        dome = dome/max(dome(:));
