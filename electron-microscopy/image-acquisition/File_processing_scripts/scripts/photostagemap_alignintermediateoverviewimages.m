function param=photostagemap_alignintermediateoverviewimages(param)
...
lparam=param.alignintermediateoverviewimages;
...
for w=param.processwafers
  ...
  for i=1:1:nrofslices-1
    imagename=[param.intermediateoverviewimages.targetdirectory sprintf(param.intermediateoverviewimages.filenametemplate,w,stsec(i,1),stsec(i,2))];
    ...
    for jc=1:1:size(parr,1)
      ...
      imagename2=[param.intermediateoverviewimages.targetdirectory sprintf(param.intermediateoverviewimages.filenametemplate,w,stsec(j,1),stsec(j,2))];
...
%       gcorr(i,j)=C;
  ...
  param.alignintermediateoverviewimages.gavail{w}=gavail;
  param.alignintermediateoverviewimages.gtransx{w}=gtransx;
  param.alignintermediateoverviewimages.gtransy{w}=gtransy;
  param.alignintermediateoverviewimages.grot{w}=grot;
  param.alignintermediateoverviewimages.gcorr{w}=gcorr;
  param.alignintermediateoverviewimages.gmatrix{w}=gmatrix;
  param.alignintermediateoverviewimages.stsec{w}=stsec;
end;
