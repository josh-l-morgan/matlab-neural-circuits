function gather_images(sourcedir,sourcefiletemplate)
%gather_images.m
...
targetdir_gathered='E:/SEM_Users/dmankus/retina_downsampled_stitched_gathered/';
%downscaledtargetsize=2048;
gatheredfileextension='.tif'; %downscaledfileextension='_downscaled.png';
gatheredfiletype='tif'; %downscaledfiletype='png';
...
%     if nrofscanfaults>0
%       name=overallfilelist{outlierspos{f}}; %sprintf(param.baserawname,slice+param.firstslice-1);
%       if (nrofscanfaults==1)
