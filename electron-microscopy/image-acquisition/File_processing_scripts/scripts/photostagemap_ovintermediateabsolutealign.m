function param=photostagemap_ovintermediateabsolutealign(param)
...
lparam=param.ovintermediateabsolutealign;

for w=param.processwafers
  nrofslices=size(param.alignintermediateoverviewimages.stsec{w},1); %size(param.generatestagemap.linearslicepos{w},1);
  gavail=param.alignintermediateoverviewimages.gavail{w};
  gtransx=param.alignintermediateoverviewimages.gtransx{w};
  gtransy=param.alignintermediateoverviewimages.gtransy{w};
  grot=param.alignintermediateoverviewimages.grot{w};
  gcorr=param.alignintermediateoverviewimages.gcorr{w};
  gmatrix=param.alignintermediateoverviewimages.gmatrix{w};
  ...
  param.ovintermediateabsolutealign.gabsmatrixcount{w}=gabsmatrixcount;
  param.ovintermediateabsolutealign.gabsmatrix{w}=ggabsmatrix;
end;