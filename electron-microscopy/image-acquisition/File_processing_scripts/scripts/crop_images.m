function crop_images(sourcedir,sourcefiletemplate)
%crop_images.m
...
targetdir_cropped='c:/SEM_Users/Commons/images/cropped/';
croppedfileextension='.tif';
croppedfiletype='tif';
...
%   disp(txt);
  ...
  k=getkeywait(2); %Wait 2 seconds for keypress
