function param=pipeline_getrelrot(param)
...
param.relrot.rotarr1=rotarr;
param.relrot.transxarr1=transxarr;
param.relrot.transyarr1=transyarr;

%   
%   save('ROI_rigid.mat','rotarr','transxarr','transyarr');
%   
% else
%   load('ROI_rigid.mat');
%   
...
%       
%       subplot(3,1,2);
%       plot(squeeze(transxarr(:,row,column)*scale),'r');
%       grid on;
%       title('Relative X Translation');
%       xlabel('Slice');
%       
%       subplot(3,1,3);
%       plot(squeeze(transyarr(:,row,column)*scale),'r');
%       grid on;
%       title('Relative Y Translation');
%       xlabel('Slice');
%       
...
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Now, for |relative rotations| > 10°, check again with filtering
% % 
% % compute2=1;
% % scale=16;
% % 
...
% %     if (abs(rotarr(slice,1,1))>10) || (abs(rotarr(slice,1,2))>10) || ((abs(rotarr(slice,1,1))-abs(rotarr(slice,1,2)))>10)
% %       slice
% %       for column=1:1:2
...
% %         end;
% %         %corrarr(slice,:)=corrval;
% %         transxarr(slice,row,column)=transx(D);
% %         transyarr(slice,row,column)=transy(D);
% %       end;
% %     end;
% %   end;
% %   save('smg_rigid2.mat','rotarr','transxarr','transyarr');
% % 
% % else
% %   load('smg_rigid2.mat');
% % end;
...
% %     subplot(3,1,1);
% %     hold on;
% %     plot(squeeze(rotarr(:,row,column)),'b');
% %     grid on;
% %     title('Relative Rotation');
% %     xlabel('Slice');
% %     hold off;
...
% %     subplot(3,1,2);
% %     hold on;
% %     plot(squeeze(transxarr(:,row,column)*scale),'b');
% %     grid on;
% %     title('Relative X Translation');
% %     xlabel('Slice');
% %     hold off;
...
% %     subplot(3,1,3);
% %     hold on;
% %     plot(squeeze(transyarr(:,row,column)*scale),'b');
% %     grid on;
% %     title('Relative Y Translation');
% %     xlabel('Slice');
% %     hold off;
