...
shrinkIt(1) = 1.2 * 0.9791;%1.46057 ;
shrinkIt(2) =  1.2 * .9104 * .9798;% 1.36234;
...
for i = 1:length(Is)
        ...
        stripI(yrange+H,xrange) = stripI(yrange+H,xrange) + fliplr(I);
end
stripI = stripI(H+1:end - H,:);
