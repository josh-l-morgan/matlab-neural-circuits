...
SEMcutsPerHour = 100000000; %% Cutting speed
SEMplanesStainedPerHour = 100000000; %% number of planes stained per day

SEMpixelsPerSecond = 8 * 10^9; %% Imaging speed

SEMminBetweenPlanes = 0; %% minutes between Planes
SEMtileSize = 25000 * 25000; %% size of SEM tile
SEMsecondsBetweenTiles = 1; %% seconds between tiles within a plane

%% TEM numbers

TEMcutsPerHour = 1000 %% Cutting speed
TEMplanesStainedPerHour = 1000000; %% number of planes stained per day

TEMpixelsPerSecond = 120 * 10^6; %% Imaging speed
TEMminBetweenPlanes = 5; %% minutes between Planes
TEMtileSize = 3024 *2024 * 61; %% size of SEM tile
TEMsecondsBetweenTiles = 30; %% seconds between tiles within a plane
