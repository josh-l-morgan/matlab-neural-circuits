...
xLengths = zLengths;% [ 1 1 1 1 1] * 200; %xy length in microns
...
AutoFocusFrequency = .4; % number of times to autofocus / num tiles
AutoStigTime = 3;
AutoStigFrequency = 0.4;
Tile2TileSoftwareTime = .05;
