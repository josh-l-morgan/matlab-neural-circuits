...
gridSubs.lookDist = lookDist;
gridSubs.gridSize = gridSize;
...
gridSubs.preList = preList;
gridSubs.postList = postList;
...
gridSubs.synMat = synMat;
gridSubs.touchMat = touchMat;
gridSubs.synTrack = synTrack;
gridSubs.arborTrack = trackArborOverlap;
...
%%
save([TPN 'gridSubs.mat'],'gridSubs')
