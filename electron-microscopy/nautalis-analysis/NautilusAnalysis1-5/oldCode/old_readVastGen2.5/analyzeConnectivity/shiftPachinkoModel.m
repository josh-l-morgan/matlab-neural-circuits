...
TPN = [MPN 'manyTerSubs\'];
load([TPN 'shiftTer_b_Ds8_Ds1_Look0_Dim1.mat']);

%sprintf('shiftTerNo108_b_Ds%d_Ds%d_Look%d_Dim%d.mat',8,downSamp,lookDist,shiftDim)
...
plot(shiftTer.shiftUm,meanRandSqrC,'LineWidth',3)
