function[useList] = obI2nodes_rtl_plus1(obI,plusOne);
...
for i = 1:length(nodes)
    if obI.nameProps.rgc(obI.cell.mainObID(i))
        nodeType(i) = 1;
    elseif obI.nameProps.tcr(obI.cell.mainObID(i))
        nodeType(i) = 2;
    elseif obI.nameProps.lin(obI.cell.mainObID(i))
        nodeType(i) = 3;
    end
    
end

useNodes = (nodes>0) & (nodeType>0) & (nodeType < 3);
