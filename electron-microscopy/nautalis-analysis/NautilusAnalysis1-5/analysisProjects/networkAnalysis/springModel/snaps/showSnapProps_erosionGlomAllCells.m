...
[checkIDs checkProp] = getList_meanDiam;
 ...
 [checkIDs checkProp] = getList_cladeCol;
    glomList = getList_glomID();
    checkIDs = glomList(:,1);
    checkProp = glomList(:,2);

    
  
    checkIDs = []; checkProp = [];
    lookupCol = [ 0 1 0 ;  1 .2 0 ; 0 .2 1 ; 1 0 1 ; 1 1 0 ; 0 .2 1 ] ;
    ...
    for i = 1:length(glomList)
        ...
        isGlom = glomList{i};
           ...
           checkIDs = [checkIDs; isGlom'];
           checkProp = [checkProp; isGlom' * 0 + i];
    end
    checkProp = lookupCol(checkProp,:);  
...
if 0
    ...
    itag  = 'erosionGlomColor2_allCells';
