...
springDir = 'D:\LGNs1\Analysis\springDat\snapLongNoSeedsSynAll\';
...
springDat = springParameters_X01_synAllSnap(springIn);
...
save([springRes 'res_snapLongNoSeedsAllSynRemoval.mat'],'allResults')
