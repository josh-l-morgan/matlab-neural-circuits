...
springDat = springParameters_X01_randSnap(springIn);
...
%% Save
saveName = 'res_randNoSeedFilt1Wait30run1000a.mat'
if ~exist([springRes saveName],'var')
    save([springRes saveName],'allResults')
end
