...
springDir = 'D:\LGNs1\Analysis\springDat\snapLongWithSeeds2\';
...
springDat = springParameters_X01_randomSnap(springIn);
...
save([springRes 'res_snapLongWithSeedsRandomEdgeRemoval.mat'],'allResults')
