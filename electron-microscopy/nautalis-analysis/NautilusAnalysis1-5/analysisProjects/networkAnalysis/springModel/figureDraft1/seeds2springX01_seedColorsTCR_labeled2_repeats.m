...
springDat = springParameters_X01_figDraftNoPropRerun(springIn);
...
springDirSub = [springDir 'whiteBackground\'];
if ~exist(springDirSub,'dir'),mkdir(springDirSub),end
for rerun = 1: 1
...
%     
    epsName = sprintf('%sspringRun_%s_%d.eps',springDirSub,tag,rerun);
