function[springDat] = springParameters_X01_figDraftBigProp(springIn)
...
edges.width = [2*sqrt(syns.ew); juncs.ew * 3];
...
nodes.color = nodeCol;
if isfield(springIn,'nodeEdgeColor')
    nodes.nodeEdgeColor = springIn.nodeEdgeColor;
else
    nodes.nodeEdgeColor = nodeCol *0+1;
end
