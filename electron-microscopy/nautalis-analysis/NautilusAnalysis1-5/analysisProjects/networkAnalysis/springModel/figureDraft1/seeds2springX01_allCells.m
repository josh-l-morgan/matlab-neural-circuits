...
if loadData
    ...
    [allIDs cellType]  = getList_cellTypes();
    useList = obI2cellList_prePostList2Use(obI,allIDs(cellType==1),allIDs(cellType==3));
...
springDat = springParameters_X01_keepSeeds(springIn);
