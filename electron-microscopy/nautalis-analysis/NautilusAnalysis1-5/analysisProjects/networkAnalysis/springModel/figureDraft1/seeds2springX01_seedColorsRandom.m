...
springDir = 'D:\LGNs1\Analysis\springDat\figDraft1\';
...
load([springRes 'res_all_randEdge_edit1.mat'])
...
allEdges = ranomizeNonSeed(nodeIDs,seedList,allEdges);
...
save([springRes 'res_all_randEdge.mat'],'result')
