...
colorTable = [ 1 0 0; 0 1 0; 0 1 1.5; 1 0 1.5; 1 1 0; 1 0 1;] 

col = [];
allMembers = [];
useClade = [1 2];
    diffList = getList_glomID([2]);
...
if 0
   I_stack = showRotation(viewProps,[0 30 60 90]);
   playRot(I_stack);
...
if 0
    ...
    image(uint8(I))
    %%
    %   imwrite(uint8(I),[cellPicDir 'glomAx.png'])
