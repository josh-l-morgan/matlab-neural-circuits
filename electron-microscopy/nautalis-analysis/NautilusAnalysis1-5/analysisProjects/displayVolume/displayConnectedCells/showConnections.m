...
allCells = obI.nameProps;


viewProps.dim =1;
showCell = [108 109 1006];
showCellNames = cat(2,num2cell(showCell),'109 part 1006m 1isp1');
...
%{
pop1 = conTo(3).tcrList;
pop2 = conTo(4).tcrList;
pop3 = [201];
...
%{
imwrite(uint8(showSyn*.2),[cellPicDir 'cyanSymmetricCellsFrom2003.png'])
%}
