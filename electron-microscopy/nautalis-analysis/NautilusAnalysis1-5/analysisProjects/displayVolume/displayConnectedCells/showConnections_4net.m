...
pop1 = [conTo(1).rgcList conTo(4).rgcList];%[9102:9107];
pop2 = [conTo(2).rgcList conTo(3).rgcList];%[9101 9108 9109 9110 ];
pop3 = [conTo(3).rgcList conTo(4).rgcList];%[108 201 907 903];
...
pop2 = [conTo(2).targ conTo(3).targ];%[9101 9108 9109 9110 ];
pop3 = [conTo(3).targ conTo(4).targ];%[108 201 907 903];
