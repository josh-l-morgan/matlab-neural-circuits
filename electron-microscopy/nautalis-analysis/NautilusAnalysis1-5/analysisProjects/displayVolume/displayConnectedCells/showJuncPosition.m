...
showCell = [pop1 pop2 ];
showCell = intersect([10 170 5000:6000 2038], obI.cell.name)
showCell = intersect([170 conTo(2).postList'], obI.cell.name)
showCell = [synapses(:,1);synapses(:,2)];
showCell = showCell(showCell>0);

showCellNames = cat(2,num2cell(showCell)','junc');

col = ones(length(showCell),3)*.3;
col = [col; [10 0 0]]
...
%{
imwrite(uint8(showSyn),[cellPicDir 'twoOT.png'])
%}
