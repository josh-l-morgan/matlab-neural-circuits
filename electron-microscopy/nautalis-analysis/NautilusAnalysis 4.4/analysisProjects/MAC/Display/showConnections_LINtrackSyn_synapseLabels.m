...
rotDir = 'C:\Users\jlmorgan\Documents\MAC\images\twoPrim2\';
...
group{1} = [1007 ];
group{2} = [11007];% setdiff(synTargLIN,125);
group{3} = [otherPost];% setdiff(synTargTCR,125);
group{4} = [{'Segment '}];% setdiff(unique([diTargTCR; triTargTCR]),125);
groupCol = [1 0 1; 0 2 0; 0 0 1; 2 0 0];
