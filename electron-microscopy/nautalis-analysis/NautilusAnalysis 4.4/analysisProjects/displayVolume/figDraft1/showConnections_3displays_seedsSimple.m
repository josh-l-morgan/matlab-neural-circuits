...
colorTable = [ 1 0 0; 0 1 0; 0 1 1.5; 1 0 1.5] *3
...
%    showCellNames = cat(2,num2cell(showCell),'axon 108','axon 201','axon 903', 'axon 907');
    ...
    %col = [ 1 0 0; 0 1 0; 0 1 1.5; 1 0 1.5; 2 2 0 ;2 2 0 ; 2 2 0 ;2 2 0 ] ;
      col = [ 1 0 0; 0 1 0; 0 1 1.5; 1 0 1.5; 1 1 0 ] *2;
...
if 0
    ...
    image(uint8(I))
    %%
    %   imwrite(uint8(I),[cellPicDir 'seedsA_Esimple3.png'])
