...
if 1 % object IDs
    ...
    showCellNames =[1:length( obI.colStruc.ids)];
...
image(uint8(I_topSum*2))
    %   imwrite(uint8(I_topSum*.2),[cellPicDir 'allSeg90.png'])
...
if 0
   rotDir = 'D:\LGNs1\Analysis\movies\glomerular\seed4full2\'
...
if 0
    ...
    I = I * .1;
    keepRat = .3;
    I = uint8keepRat(I*355)*keepRat + uint8(I*1)*(1-keepRat);
    image(uint8(I))
    %%
    %   imwrite(uint8(I),[cellPicDir 'allSeg91.png'])
