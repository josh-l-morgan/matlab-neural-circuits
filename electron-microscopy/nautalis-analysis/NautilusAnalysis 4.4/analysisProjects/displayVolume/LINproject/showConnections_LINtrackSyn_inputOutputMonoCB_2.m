...
rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\inputOutput_30\';
...
for d = 1:length(degs);
    ...
    I_topSumR = stereoCellsAndMoreFull_PS(viewProps);
    I_topSum = I_topSumR;
