...
showCell = [125 postAx postTarg'];


showCellNames = cat(2,num2cell(showCell),{'125 axon'},{'axon 125'},{'bulb'});
%col = [1 1 1; repmat([1 0 0],[size(preTarg,1) 1]); repmat([0 1 0],[size(postTarg,1) 1])];
col = [1 1 1;colMap(randperm(size(colMap,1),length(showCell)-1),:)]
col = [0 10 10;repmat([1 0 0],[length(postAx) 1]);repmat([0 1 0],[length(postTarg) 1]); ...
...
if 1
    ...
    if 0
        rotDir = 'D:\LGNs1\Analysis\movies\LIN\redAx125fullAx\'
