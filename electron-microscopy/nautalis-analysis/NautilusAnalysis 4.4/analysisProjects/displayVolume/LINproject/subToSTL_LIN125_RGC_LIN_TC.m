...
obMovDir = 'D:\LGNs1\Analysis\movies\LIN_RGC_TC\'
...
group1 = 1009;%intersect(1009);
group2 = [109];%intersect();
group3 = [];%intersect();
group4 = [];%[227]
%
% group1 = 156
...
%col = [rainBow; [1 1 1]]
groupCol = [1 0 0; 0 1 0; .3 .3 1; 1 .5 0; .7 .7 .7];
...
for i = 1%:length(az);
    ...
    for n = 1:100000
        if ~exist(imageName,'file')
          ...
          imageName = sprintf('%srot_%05.0f.png',obMovDir,n);
