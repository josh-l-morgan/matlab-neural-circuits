...
rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\inputOutput_16\';
...
synType = {  'bar'      'bar'       'bar'       'ball'      'ball'      'x'};
synCol = [   0 1 0;    .2 .2 1;    1 0 1;      1 0 0;     .2 .2 1;     .4 .6 2] * 1;
var1 = [    32          32          32          24          24          30];
var2 = [    3           3           3           5           6           30]
...
for d = 1:length(degs);
   ...
   % I_topSum = outline(I_topSum,8);
    ...
    showSynTrack = outline(showSynTrack,3);
