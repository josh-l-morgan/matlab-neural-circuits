rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\Autapse_0000\';
...
synPos125autapse = cat(1,mot.syn.synPos{to125 & from125,:});
synPos125autapseRaw = cat(1,mot.syn.synPosRaw{to125 & from125});
synPos125autapseRaw = synPos125autapseRaw(:,[2 1 3]);
...
synType = {'x' 'bar' 'bar' 'bar' 'ring' 'ring' 'ring'};
synCol = [1 0 0 ; .2 .2 1; 1 0 1;  1 0 0; .2 .2 1];
var1 = [ 40 16 24 16 16 24];
var2 = [ 40 4 6 4 3 3 4]
...
%     hold off
    ...
    if 1
        rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\inputTypesSynPos_10\';
