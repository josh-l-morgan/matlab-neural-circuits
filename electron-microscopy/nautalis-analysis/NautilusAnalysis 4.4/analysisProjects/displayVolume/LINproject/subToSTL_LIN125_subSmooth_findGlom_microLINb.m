...
obMovDir = 'D:\LGNs1\Analysis\movies\subLin125_Glom2c_SynOFF_scaleBar2\'
...
cellList = cat(2,{125},'linA', group1, group2, group3, group4, group5);
%cellList = [125];
...
col = [groupCol(1,:);groupCol(1,:);group2Col; ...
...
alph = [groupAlph(1);groupAlph(1);repmat(groupAlph(2),[length(group1) 1]);repmat(groupAlph(3),[length(group2) 1]);...
