...
checkPos = cat(1,mot.syn.synPosRaw{toUNK,:});
checkPos = checkPos(:,[2 1 3]);
...
useSyn{6} =  synPos125toUNK;


synType = {'bar' 'bar' 'bar' 'ring' 'ring' 'ring'};
synCol = [0 1 0 ; .2 .2 1; 1 0 1;  1 0 0; .2 .2 1; 1 0 1];
var1 = [ 16 32 32 16 24 32];
var2 = [ 4 6 6 3 3 4 6]
