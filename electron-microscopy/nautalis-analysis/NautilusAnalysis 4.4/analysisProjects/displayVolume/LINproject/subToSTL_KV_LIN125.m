...
obMovDir = 'D:\LGNs1\Analysis\movies\subLin125_kt\'
...
%load('MPN.mat')
MPN = 'D:\otherPeoplesData\Katia\export_Katia125_2019+01+18\';
load([MPN 'obI.mat'])
load([MPN 'dsObj.mat'])
...
if region == 1
    isLocal = [ 125];% 221 353 402]; %% shaft synapses1
else
...
cellList = { group1 group2 group3 group4};
%cellList = [125];
