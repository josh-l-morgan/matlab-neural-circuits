...
rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\inputOutput_23\';
...
groupCol = [1 1 1; 0 5 2; 0 0 1; 1 0 0];
...
synType = {  't'      'bar'       'p'       'disk'      'bar'      'x'};
synCol = [   0 1 0;    1 0 0;    1 1 0;      .3 .3 1;     1 0 0;     .4 .6 2];
var1 = [    32          32          32          32          32          30];
var2 = [    32          32          32          32          32          30]
