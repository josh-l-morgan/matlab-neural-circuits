...
pop2 = [conTo(2).tcrList conTo(5).tcrList ];%[9101 9108 9109 9110 ];
pop3 = [conTo(3).tcrList conTo(4).tcrList  conTo(5).tcrList ];%[108 201 907 903];
% 
pop1 = [conTo(1).rgcList  ];%[9102:9107];
pop2 = [conTo(2).rgcList conTo(3).rgcList conTo(5).rgcList conTo(4).rgcList];%[9101 9108 9109 9110 ];
pop3 = [conTo(3).rgcList conTo(4).rgcList  conTo(5).rgcList ];%[108 201 907 903];

pop1 = [conTo(1).rgcList  ];%[9102:9107];
pop2 = [conTo(2).rgcList ];%[9101 9108 9109 9110 ];
pop3 = [axnet3 ];%[108 201 907 903];



% 
% pop1 = [conTo(4).tcrList  ];%[9102:9107];
% pop2 = [conTo(2).tcrList];%[9101 9108 9109 9110 ];
% pop3 = [ conTo(4).tcrList ];%[108 201 907 903];
% 



% 
pop1 = [conTo(1).targ conTo(4).targ ];%[9102:9107];
pop2 = [conTo(2).targ conTo(5).targ ];%[9101 9108 9109 9110 ];
pop3 = [conTo(3).targ conTo(4).targ  conTo(5).targ ];%[108 201 907 903];
% % 
% 
% pop1 = [ conTo(1).rgcList ];%[9102:9107];
% pop2 = [ conTo(2).rgcList ];%[9101 9108 9109 9110 ];
% pop3 = [ conTo(3).rgcList ];%[108 201 907 903];
% 
% 
...
% 
% 
% pop1 = [conTo(3).tcrList ];%[9102:9107];
% pop2 = [conTo(4).tcrList ];%[9101 9108 9109 9110 ];
% pop3 = [conTo(5).tcrList ];%[108 201 907 903];
% 
...
%{
imwrite(uint8(showSyn*.1),[cellPicDir 'magentaCyanFourTarg3.png'])
%}
