...
obMovDir = 'D:\LGNs1\Analysis\motifImages\batch3\'
...
if oneAtATime == 1
    ...
    motSize = [200 200 200 200 200 200 200 200 200 200 ...
        ...
        200 200 200  200  200 200 200 200 200 200];
    for i = 1:motNum, motSize(i) = 25^2; end
    
    
    
    for i = 1:motNum, motSize(i) = 25^2; end
    motSize(7) = 50^2;
    for i = 1:motNum, motCol{i} = [0 0 0]; end
    for i = 1:motNum, clustCol{i} = [0 0 1]; end
    for i = 1:motNum, edgeCol{i} = [.6 .6 .6]; end
...
%             'markerfacecolor',motCol{i}, 'markeredgecolor',edgeCol{i},'linewidth',markWidth)
     scatter3(pos(:,1),pos(:,2),pos(:,3),motSize(i),'marker',motMark{i},...
             'markeredgecolor',edgeCol{i},'linewidth',markWidth)
