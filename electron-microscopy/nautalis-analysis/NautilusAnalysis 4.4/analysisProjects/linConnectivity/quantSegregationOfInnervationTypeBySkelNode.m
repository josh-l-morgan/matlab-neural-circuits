...
ttConRat = mean(ttConRats(1:5))
ttConTot = mean(ttPostMatch(1:5) + ttPostDif(1:5))
ssConRat = mean(ssConRats(1:5))
ssConTot = mean(ssPostMatch(1:5) + ssPostDif(1:5))
...
ttConRatRand = mean(ttConRatsRand(1:5))
ttConTotRand = mean(ttPostMatchRand(1:5) + ttPostDifRand(1:5))
ssConRatRand = mean(ssConRatsRand(1:5))
ssConTotRand = mean(ssPostMatchRand(1:5) + ssPostDifRand(1:5))
