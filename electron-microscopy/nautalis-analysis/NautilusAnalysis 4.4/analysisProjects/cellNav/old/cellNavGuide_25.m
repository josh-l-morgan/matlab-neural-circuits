function varargout = cellNavGuide_25(varargin)
% CELLNAVGUIDE_25 MATLAB code for cellNavGuide_25.fig
%      CELLNAVGUIDE_25, by itself, creates a new CELLNAVGUIDE_25 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_25 returns the handle to a new CELLNAVGUIDE_25 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_25('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_25.M with the given input arguments.
%
%      CELLNAVGUIDE_25('Property','Value',...) creates a new CELLNAVGUIDE_25 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_25_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_25_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_25

% Last Modified by GUIDE v2.5 14-Jun-2020 21:09:52
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_25_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_25_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_25 is made visible.
function cellNavGuide_25_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_25 (see VARARGIN)

% Choose default command line output for cellNavGuide_25
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_25 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_25_OutputFcn(hObject, eventdata, handles)
...
if val
    ...
    glob.dcmR = datacursormode(handles.figure1);
    glob.dcmR.UpdateFcn = @cursorSelectRef;
    
    set(glob.dcmR,'DisplayStyle','datatip',...
        'SnapToDataVertex','off','Enable','on')
else
    rotate3d(handles.figure1)
    delete(findall(handles.figure1,'Type','hggroup'))
...
function edit1_alpha_Callback(hObject, eventdata, handles)
% hObject    handle to edit1_alpha (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit1_alpha as text
%        str2double(get(hObject,'String')) returns contents of edit1_alpha as a double


% --- Executes during object creation, after setting all properties.
function edit1_alpha_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit1_alpha (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
