function varargout = cellNavGuide_11(varargin)
% CELLNAVGUIDE_11 MATLAB code for cellNavGuide_11.fig
%      CELLNAVGUIDE_11, by itself, creates a new CELLNAVGUIDE_11 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_11 returns the handle to a new CELLNAVGUIDE_11 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_11.M with the given input arguments.
%
%      CELLNAVGUIDE_11('Property','Value',...) creates a new CELLNAVGUIDE_11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_11

% Last Modified by GUIDE v2.5 11-May-2020 15:14:18
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_11_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_11_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_11 is made visible.
function cellNavGuide_11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_11 (see VARARGIN)

% Choose default command line output for cellNavGuide_11
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_11 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_11_OutputFcn(hObject, eventdata, handles)
