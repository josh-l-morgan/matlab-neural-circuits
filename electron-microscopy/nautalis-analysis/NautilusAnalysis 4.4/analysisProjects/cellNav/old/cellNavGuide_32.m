function varargout = cellNavGuide_32(varargin)
% CELLNAVGUIDE_32 MATLAB code for cellNavGuide_32.fig
%      CELLNAVGUIDE_32, by itself, creates a new CELLNAVGUIDE_32 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_32 returns the handle to a new CELLNAVGUIDE_32 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_32('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_32.M with the given input arguments.
%
%      CELLNAVGUIDE_32('Property','Value',...) creates a new CELLNAVGUIDE_32 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_32_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_32_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_32

% Last Modified by GUIDE v2.5 16-Jun-2020 21:47:11
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_32_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_32_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_32 is made visible.
function cellNavGuide_32_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_32 (see VARARGIN)

% Choose default command line output for cellNavGuide_32
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_32 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_32_OutputFcn(hObject, eventdata, handles)
