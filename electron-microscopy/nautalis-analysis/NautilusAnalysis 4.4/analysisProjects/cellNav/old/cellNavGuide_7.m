function varargout = cellNavGuide_7(varargin)
% CELLNAVGUIDE_7 MATLAB code for cellNavGuide_7.fig
%      CELLNAVGUIDE_7, by itself, creates a new CELLNAVGUIDE_7 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_7 returns the handle to a new CELLNAVGUIDE_7 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_7.M with the given input arguments.
%
%      CELLNAVGUIDE_7('Property','Value',...) creates a new CELLNAVGUIDE_7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_7

% Last Modified by GUIDE v2.5 08-May-2020 16:20:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @cellNavGuide_7_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_7_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_7 is made visible.
function cellNavGuide_7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_7 (see VARARGIN)

% Choose default command line output for cellNavGuide_7
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_7 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_7_OutputFcn(hObject, eventdata, handles)
...
if val
    ...
    col = repmat([1 0 0],[length(isSyn) 1]);
    isBip = find(postClass==1);
    hold on
    glob.p.postSyn1 = scatter3(pos(:,1),pos(:,2),pos(:,3),glob.param.markerSize,'markerfacecolor','m',...
        'marker','o','markeredgecolor','w');
    glob.p.postSyn2 = scatter3(pos(isBip,1),pos(isBip,2),pos(isBip,3),glob.param.markerSize,'markerfacecolor','b',...
        'marker','o','markeredgealpha',0);
