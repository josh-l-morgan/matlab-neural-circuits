function varargout = cellNavGuide_18(varargin)
% CELLNAVGUIDE_18 MATLAB code for cellNavGuide_18.fig
%      CELLNAVGUIDE_18, by itself, creates a new CELLNAVGUIDE_18 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_18 returns the handle to a new CELLNAVGUIDE_18 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_18('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_18.M with the given input arguments.
%
%      CELLNAVGUIDE_18('Property','Value',...) creates a new CELLNAVGUIDE_18 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_18_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_18_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_18

% Last Modified by GUIDE v2.5 11-Jun-2020 20:03:29
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_18_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_18_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_18 is made visible.
function cellNavGuide_18_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_18 (see VARARGIN)

% Choose default command line output for cellNavGuide_18
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_18 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_18_OutputFcn(hObject, eventdata, handles)
...
txt = tag;
set(info.Target,'FaceAlpha',1,'FaceColor',[1 1 1])
