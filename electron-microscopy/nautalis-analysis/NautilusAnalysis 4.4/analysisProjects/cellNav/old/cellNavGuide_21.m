function varargout = cellNavGuide_21(varargin)
% CELLNAVGUIDE_21 MATLAB code for cellNavGuide_21.fig
%      CELLNAVGUIDE_21, by itself, creates a new CELLNAVGUIDE_21 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_21 returns the handle to a new CELLNAVGUIDE_21 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_21('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_21.M with the given input arguments.
%
%      CELLNAVGUIDE_21('Property','Value',...) creates a new CELLNAVGUIDE_21 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_21_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_21_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_21

% Last Modified by GUIDE v2.5 13-Jun-2020 17:34:01
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_21_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_21_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_21 is made visible.
function cellNavGuide_21_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_21 (see VARARGIN)

% Choose default command line output for cellNavGuide_21
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_21 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_21_OutputFcn(hObject, eventdata, handles)
...
funcIDs = funcIDs(funcIDs<= length(glob.com.functions));
if ~isempty(funcIDs)
    funcStrs = glob.com.functions{funcIDs};
else
    funcStrs = ' ';
end
set(handles.popupmenu7,'String',funcStrs);
...
% --- Executes on button press in text_Function.
function text_Function_Callback(hObject, eventdata, handles)
% hObject    handle to text_Function (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if iscell(str)
    str = str{get(handles.popupmenu7,'Value')};
end
output = eval(str);
...
% --- Executes on button press in text_eval.
function text_eval_Callback(hObject, eventdata, handles)
% hObject    handle to text_eval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
