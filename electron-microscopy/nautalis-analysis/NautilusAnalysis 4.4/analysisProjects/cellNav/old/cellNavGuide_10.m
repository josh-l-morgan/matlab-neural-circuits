function varargout = cellNavGuide_10(varargin)
% CELLNAVGUIDE_10 MATLAB code for cellNavGuide_10.fig
%      CELLNAVGUIDE_10, by itself, creates a new CELLNAVGUIDE_10 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_10 returns the handle to a new CELLNAVGUIDE_10 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_10('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_10.M with the given input arguments.
%
%      CELLNAVGUIDE_10('Property','Value',...) creates a new CELLNAVGUIDE_10 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_10_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_10_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_10

% Last Modified by GUIDE v2.5 11-May-2020 11:45:58
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_10_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_10_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_10 is made visible.
function cellNavGuide_10_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_10 (see VARARGIN)

% Choose default command line output for cellNavGuide_10
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_10 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_10_OutputFcn(hObject, eventdata, handles)
