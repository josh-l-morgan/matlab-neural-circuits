function varargout = cellNavGuide_17(varargin)
% CELLNAVGUIDE_17 MATLAB code for cellNavGuide_17.fig
%      CELLNAVGUIDE_17, by itself, creates a new CELLNAVGUIDE_17 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_17 returns the handle to a new CELLNAVGUIDE_17 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_17('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_17.M with the given input arguments.
%
%      CELLNAVGUIDE_17('Property','Value',...) creates a new CELLNAVGUIDE_17 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_17_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_17_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_17

% Last Modified by GUIDE v2.5 10-Jun-2020 15:08:11
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_17_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_17_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_17 is made visible.
function cellNavGuide_17_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_17 (see VARARGIN)

% Choose default command line output for cellNavGuide_17
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_17 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_17_OutputFcn(hObject, eventdata, handles)
