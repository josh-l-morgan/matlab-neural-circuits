function varargout = cellNavGuide_12(varargin)
% CELLNAVGUIDE_12 MATLAB code for cellNavGuide_12.fig
%      CELLNAVGUIDE_12, by itself, creates a new CELLNAVGUIDE_12 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_12 returns the handle to a new CELLNAVGUIDE_12 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_12('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_12.M with the given input arguments.
%
%      CELLNAVGUIDE_12('Property','Value',...) creates a new CELLNAVGUIDE_12 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_12_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_12_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_12

% Last Modified by GUIDE v2.5 12-May-2020 19:05:42
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_12_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_12_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_12 is made visible.
function cellNavGuide_12_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_12 (see VARARGIN)

% Choose default command line output for cellNavGuide_12
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_12 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_12_OutputFcn(hObject, eventdata, handles)
