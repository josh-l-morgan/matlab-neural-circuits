function varargout = cellNavGuide_5(varargin)
% CELLNAVGUIDE_5 MATLAB code for cellNavGuide_5.fig
%      CELLNAVGUIDE_5, by itself, creates a new CELLNAVGUIDE_5 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_5 returns the handle to a new CELLNAVGUIDE_5 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_5.M with the given input arguments.
%
%      CELLNAVGUIDE_5('Property','Value',...) creates a new CELLNAVGUIDE_5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_5

% Last Modified by GUIDE v2.5 08-May-2020 09:41:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cellNavGuide_5_OpeningFcn, ...
                   'gui_OutputFcn',  @cellNavGuide_5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_5 is made visible.
function cellNavGuide_5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_5 (see VARARGIN)

% Choose default command line output for cellNavGuide_5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_5 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_5_OutputFcn(hObject, eventdata, handles) 
