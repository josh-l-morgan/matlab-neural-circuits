function varargout = cellNavGuide_3(varargin)
% CELLNAVGUIDE_3 MATLAB code for cellNavGuide_3.fig
%      CELLNAVGUIDE_3, by itself, creates a new CELLNAVGUIDE_3 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_3 returns the handle to a new CELLNAVGUIDE_3 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_3.M with the given input arguments.
%
%      CELLNAVGUIDE_3('Property','Value',...) creates a new CELLNAVGUIDE_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_3

% Last Modified by GUIDE v2.5 07-May-2020 20:28:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cellNavGuide_3_OpeningFcn, ...
                   'gui_OutputFcn',  @cellNavGuide_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_3 is made visible.
function cellNavGuide_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_3 (see VARARGIN)

% Choose default command line output for cellNavGuide_3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_3 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_3_OutputFcn(hObject, eventdata, handles) 
...
glob.p.cell.FaceLighting = 'gouraud';
glob.p.cell.AmbientStrength = .35;%.4; shadowColor
glob.p.cell.DiffuseStrength = 1;%.1;
glob.p.cell.SpecularStrength = .8;
glob.p.cell.SpecularExponent = 3;
glob.p.cell.BackFaceLighting = 'lit';
glob.p.cell.Clipping = 'off';
