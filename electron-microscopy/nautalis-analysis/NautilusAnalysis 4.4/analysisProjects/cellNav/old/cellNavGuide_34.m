function varargout = cellNavGuide_34(varargin)
% CELLNAVGUIDE_34 MATLAB code for cellNavGuide_34.fig
%      CELLNAVGUIDE_34, by itself, creates a new CELLNAVGUIDE_34 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_34 returns the handle to a new CELLNAVGUIDE_34 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_34('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_34.M with the given input arguments.
%
%      CELLNAVGUIDE_34('Property','Value',...) creates a new CELLNAVGUIDE_34 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_34_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_34_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_34

% Last Modified by GUIDE v2.5 17-Jun-2020 12:25:08
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_34_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_34_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_34 is made visible.
function cellNavGuide_34_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_34 (see VARARGIN)

% Choose default command line output for cellNavGuide_34
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_34 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_34_OutputFcn(hObject, eventdata, handles)
...
str = {'Import Data', 'Customize Groups','Model Transmission'};
set(hObject,'String',str);
