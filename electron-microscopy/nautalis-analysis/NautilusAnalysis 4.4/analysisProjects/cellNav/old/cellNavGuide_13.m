function varargout = cellNavGuide_13(varargin)
% CELLNAVGUIDE_13 MATLAB code for cellNavGuide_13.fig
%      CELLNAVGUIDE_13, by itself, creates a new CELLNAVGUIDE_13 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_13 returns the handle to a new CELLNAVGUIDE_13 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_13('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_13.M with the given input arguments.
%
%      CELLNAVGUIDE_13('Property','Value',...) creates a new CELLNAVGUIDE_13 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_13_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_13_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_13

% Last Modified by GUIDE v2.5 13-May-2020 17:06:50
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_13_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_13_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_13 is made visible.
function cellNavGuide_13_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_13 (see VARARGIN)

% Choose default command line output for cellNavGuide_13
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_13 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_13_OutputFcn(hObject, eventdata, handles)
...
glob.p.refCell(i) = renderFVnav(fv,[1 0 0],1);
