function varargout = cellNavGuide_27(varargin)
% CELLNAVGUIDE_27 MATLAB code for cellNavGuide_27.fig
%      CELLNAVGUIDE_27, by itself, creates a new CELLNAVGUIDE_27 or raises the existing
%      singleton*.
%
%      H = CELLNAVGUIDE_27 returns the handle to a new CELLNAVGUIDE_27 or the handle to
%      the existing singleton*.
%
%      CELLNAVGUIDE_27('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CELLNAVGUIDE_27.M with the given input arguments.
%
%      CELLNAVGUIDE_27('Property','Value',...) creates a new CELLNAVGUIDE_27 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cellNavGuide_27_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cellNavGuide_27_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cellNavGuide_27

% Last Modified by GUIDE v2.5 15-Jun-2020 14:32:34
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @cellNavGuide_27_OpeningFcn, ...
    'gui_OutputFcn',  @cellNavGuide_27_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before cellNavGuide_27 is made visible.
function cellNavGuide_27_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cellNavGuide_27 (see VARARGIN)

% Choose default command line output for cellNavGuide_27
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cellNavGuide_27 wait for user response (see UIRESUME)
...
function varargout = cellNavGuide_27_OutputFcn(hObject, eventdata, handles)
...
hList = {'h.togglebutton_SelectPatch','h.togglebutton_PaintPatch',...
    'h.togglebutton_measurePath','h.pushDataTip','h.toggle_highlightCell',...
    'h.toggle_selectCell','h.togglebutton_pickRef'};

for i = 1:length(hList)
    set(eval(hList{i}),'Value',0);       
end
...
% --- Executes on button press in togglebutton_showPath.
function togglebutton_showPath_Callback(hObject, eventdata, handles)
% hObject    handle to togglebutton_showPath (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of togglebutton_showPath
