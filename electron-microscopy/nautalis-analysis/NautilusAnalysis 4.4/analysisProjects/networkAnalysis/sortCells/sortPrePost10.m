...
tcrList = useList.postList;
rgcList = useList.preList;
con = useList.con;    
...
%%Make symmetric
nodeList = [listPre setdiff(listPost,seedList)]
...
[preIDX,C] = jwSpec(preGraph,8)
[postIDX,C] = jwSpec(postGraph,8)
[nodeIDX,C] = jwSpec(symGraph,8)
...
%jwSpec(
specRes = useList
specRes.preIDX = preIDX;
specRes.postIDX = postIDX; 
specRes.nodeIDX = nodeIDX;
specRes.nodeList = nodeList;

save('.\data\otherClustering\specRes.mat','specRes')
