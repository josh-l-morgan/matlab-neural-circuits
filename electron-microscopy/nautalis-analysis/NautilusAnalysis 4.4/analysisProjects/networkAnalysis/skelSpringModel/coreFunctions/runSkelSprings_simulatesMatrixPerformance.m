...
kern1 = tent((fsize*fres)*2+1)*(1/nodeNum);
kern2 = tent(11*fres)*10;
...
%     
    ...
    uInds = unique(nodeInds);
    hInds = histc(nodeInds,uInds);
    fieldDis = fieldDis*0;
    ...
    sumPushX = nodeGx *  -disperse ;
    sumPushY = nodeGy *  -disperse ;
