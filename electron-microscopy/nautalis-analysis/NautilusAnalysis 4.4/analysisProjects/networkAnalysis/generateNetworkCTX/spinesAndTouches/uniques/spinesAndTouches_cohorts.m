...
%% Get Cohorts
[cohortSum,commonSyn] = findCohorts(synMat,touchMat,dendMat);
...
for r = 1:reps
    ...
    if reportOn
        ...
        badSpineNum = sum(abs(sum(synMat,1)-sum(makeSyn,1)))
        [randCohortSum(r) randCommonSyn(:,:,r)] = findCohorts(makeSyn,touchMat,dendMat);
        pause
