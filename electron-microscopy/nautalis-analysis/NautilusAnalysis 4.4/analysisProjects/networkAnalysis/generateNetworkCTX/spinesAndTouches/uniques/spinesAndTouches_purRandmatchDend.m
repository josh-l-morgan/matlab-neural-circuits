...
for r = 1:reps
    ...
    makeSyn = rand(size(synMat))<=synFrac;
    ...
    if reportOn
        ...
        disp(sprintf('%02.1f%% done,%d bad syn, %d axon mistakes, %d spine mistakes ', r/reps*100,badSyn,mistakeNum,badSpine))
        pause(.0001)
