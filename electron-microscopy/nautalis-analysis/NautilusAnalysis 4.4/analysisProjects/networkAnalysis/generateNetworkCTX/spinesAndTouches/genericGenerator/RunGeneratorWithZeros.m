...
reps = 100000;  % number of randomizations
...
if countCohorts
    [realAllCom commonSyn] = matchDend(synMat,dendMat);
...
for r = 1:reps
    ...
    if countCohorts
        [sharedAx(r) randCommonSyn(:,:,r)] = matchDend(makeSyn,dendMat);
    end
...
if countCohorts
    ...
    selfs = sub2ind([dendNum dendNum],[1:dendNum],[1:dendNum]);
    for r = 1:reps
