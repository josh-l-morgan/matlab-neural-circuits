...
layers = 1:steps;
cladeIDmat = cellGroups + repmat(layers' * num,[1 num]);
...
%e2(1) = 1;
allEdges = [cladeIDs(2:end)' e2(2:end)'];




%% Get node order
cladeOrder{1} = cladeIDs(1);
for h = 1:max(yPos)-1
...
%{
save([springRes 'res_snapLong01_claded2.mat'],'cladeResults')
