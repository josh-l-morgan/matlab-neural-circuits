...
if loadData
    ...
    sumTemp = sum(tempList.con(:));
    
    useList = useListBoutSize(tempList);
    con = useList.con;
    con = con;
    sumUse = sum(con(:));
    ...
    [y x] = find(con>0);
    v = useList.con(con>0)* sumTemp/sumUse;
...
if 0
    seedCol = [1 0 0; 0 1 0;  0 0 1; 0 .3 1; 0 .3 1] * .75;
...
if 0  %Color TCR according to seed preference
    ...
    usePref = usePref./repmat(maxPref,[5,1]);
    
    seedCol = [1 0 0; 0 1 0;  0 .3 1; 0 .3 1; 0 .3 1] * 10;
...
save([springRes 'boutWeightDiam01.mat'],'result')
