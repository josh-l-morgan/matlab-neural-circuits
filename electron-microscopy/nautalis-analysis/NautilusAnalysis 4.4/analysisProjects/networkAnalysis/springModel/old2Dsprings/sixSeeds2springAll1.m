...
if loadData
    ...
    MPN = GetMyDir;
    load([MPN 'obI.mat']);
    seedList = [ 108  201 109 907 903 601];
...
springDir = 'D:\LGNs1\Analysis\springDat\fiveSeedsAll\'
...
seedCol = [1 0 0; 0 1 0;  0 0 1; 0 .3 1; 0 .3 1 ; .3 .3 .3] * .6; 
...
springDat = springParameters_fiveSeedsAll(springIn);
