...
seedCol = [1 0 0; 0 1 0;  0 0 1; 0 .3 1; 0 .3 1] * 1; 
seedCol = [0 0 1; 0 1 1;  1 0 1] * .6; 
...
for i = 1:length(labelCells)
   nodeCol(find(nodeIDs==labelCells(i)),2) = nodeCol(find(nodeIDs==labelCells(i)),2) + .3;    
end
