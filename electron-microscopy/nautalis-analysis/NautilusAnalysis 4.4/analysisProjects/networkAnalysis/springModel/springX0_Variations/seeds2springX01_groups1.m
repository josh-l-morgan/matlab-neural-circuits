...
springDir = 'D:\LGNs1\Analysis\springDat\snapGroup\';
springRes = 'D:\LGNs1\Analysis\springDat\results\';
load([springRes 'res_snapLong01_grouped.mat'])
allEdges = groupedResults.allEdges;
nodeIDs = groupedResults.groupIDs;
...
springDat = springParameters_X01_grouped(springIn);
...
save([springRes 'res_snapLong01.mat'],'allResults')
