...
if exist([TPN 'edited\ed' TFN])
    lI = double(imread([TPN 'edited\ed' TFN]));
    'ed'
elseif exist([TPN 'fused2\fusedlab' TFN]);
    'fused2'
    lI =double(imread([TPN 'fused2\fusedlab' TFN]));
else
    'lab'
...
button
              ...
              e      end
               ...
               sz=numel(lI);
                ...
                col0(1:sz) = red(lI+1); %.4 sec
                col0(sz+1:sz*2) = green(lI+1); %.4 sec
                col0(sz*2+1:sz*3) = blue(lI+1); %.4 sec
