...
c1 = fastCon(I,gKern1);
image(fitH(c1))
threshs= [.3:.1:.3]; % thresolds to check for edges.  later scaled
...
newBoarders = fastCon(newBorders,gaus3d([5 5 1],3))>.5;
image(newBoarders * 100)
%% Mix watersheds
...
%%
catCol =uint8(cat(3,(wI==0) * 1000, wI2 * 1000, wI * 1000));
image(catCol)
pause(.01)
%
