function[useList] = obI2cellList(obI,seedList);
...
allList = obI.cell.names(obI.cell.isCell>0);
cellList = allList((allList>=10) & (allList<1000));
axList = allList((allList>=1000)&(allList<10000));
