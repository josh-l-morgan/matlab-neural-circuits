...
if exist([TPN 'allVox.mat'],'file') & usePrevious
    load([TPN 'allVox.mat'])
else
    ...
    save([TPN 'allVox.mat'],'allVox','-v7.3')
end

%% Get obj surface
if exist([TPN 'surfVox.mat'],'file') & usePrevious
    load([TPN 'surfVox.mat'])
else
    %%
...
%     end
% end
%     showMaxProp(moveObj,pathDist*1000);
    ...
    save([TPN 'surfVox.mat'],'surfVox','-v7.3')
end
